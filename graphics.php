...
$url="http://ip-api.com/json/".$rrp;
    ...
    if ($countryCode=='IN'){
      ...
      $logo_original = '7,300';
      $brochure = '12,400';
      $brochure_original = '21,900';
      $package = '2100';
      $package_original = '10,600';
      $cover = '1400';
      $cover_original ='14,600';
      $thumbnail = '1090';
      $Thumbnail_original = '1800';
      $post = '300';
      $post_original = '360';
    }else{
      $india='no';
      ...
      $logo_original = '99';
      $brochure = '169';
      $brochure_original = '299';
      $package = '28';
      $package_original = '144';
      $cover = '19';
      $cover_original ='199';
      $thumbnail = '14.5';
      $Thumbnail_original = '24.5';
      $post = '4';
      $post_original = '4.9';
    }
?>
...
<body>
    ...
    <header class="header">
        <div class="container header__container">
            <div class="header__logo"><img class="header__img" alt='weber graphics image' src="weber-gd.svg">
                <h1 class="header__title">Weber<span class="header__light"> Graphics</span></h1>
            </div>
            ...
            <div class="header__menu">
                <nav id="navbar" class="header__nav collapse">
                    <ul class="header__elenco">
                        <li class="header__el"><a href="#" class="header__link scroll">Home</a></li>
                        <li class="header__el"><a href="#pricing" class="header__link scroll">Pricing</a></li>
                        <li class="header__el"><a href="#success" class="header__link scroll">Success stories</a>
                        </li>
                        <!-- <li class="header__el"><a href="#" class="header__link">Blog</a></li> -->
                        <li class="header__el"><a href="#contact" class="header__link scroll">Contact us</a></li>
                        <li class="header__el header__el--blue"><a href="#contact" class="btn btn--white scroll">Contact
                                →</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="sect sect--padding-top">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="site">
                        <h3 class="site__title">Welcome To The Weber Graphics</h3>
                        <h5 class="site__subtitle">Manage business like a boss</h5>
                        <div class="site__box-link">
                            <a class="btn gd btn--width scroll" href="#pricing">Pricing</a>
                            <a class="btn btn--revert btn--width" href="index">Websites</a>
                        </div>
                        <img class="site__img" alt='weber laptop svg' src="assets/lap-gd.svg">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row row--center row--margin">
                <div class="col-md-4 col-sm-4 price-box price-box--purple ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $logo_original; ?>
                        </h3>
                ...
                <div class="col-md-4 col-sm-4 price-box price-box--violet ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $brochure_original; ?>
                        </h3>
                ...
                <div class="col-md-4 col-sm-4 price-box price-box--blue ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $package_original; ?>
                        </h3>
                ...
                <div class="col-md-4 col-sm-4 price-box price-box--purple ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $cover_original; ?>
                        </h3>
                ...
                <div class="col-md-4 col-sm-4 price-box price-box--violet ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $Thumbnail_original; ?>
                        </h3>
                ...
                <div class="col-md-4 col-sm-4 price-box price-box--blue ">
                    <div class="price-box__wrap">
                        ...
                        <h3 class="price-box__price">
                            <?php echo $tag; ?><?php echo $post_original; ?>
                        </h3>
    ...
    <div class="sect sect--white" id="success">
        <div class="container">
            <div class="row">
                ...
                <h5 class="row__sub">Companies you <span class="row__sub--light">(will)</span> propably know</h5>
            </div>
                            ...
                            <div class="item active">
                                <div class="item__content">
                                    ...
                                    <span class="item__name">
                                        St. George's School</span>
                                    <p class="item__description">
                                        We always try to get the most efficient way to promote our children towards
                                        thier studies. Design's by weber are totally awesome and all our staff loved
                                        it. Wishing you a very all the best.
                                    </p>
                                </div>
  ...
  <p class="item__occupation">Ceo of Google</p> -->
                            ...
                            <div class="item">
                                <div class="item__content">
                                    ...
                                    <span class="item__name">Slice Go</span>
                                    <p class="item__description">
                                        Your awesome design's are really best for campaign's , i literally got 25k+
                                        extra impressions when compared with old. Work is really appreciable, keep
                                        going !
                                    </p>
                                </div>
                                <div class="item__avatar"></div>
  ...
  <p class="item__occupation">Ceo of Dribbble</a> -->
                            ...
                            <div class="item">
                                <div class="item__content">
                                    ...
                                    <p class="item__description">
                                        You nailed my website and the designs too. As always Wishing you best of
                                        luck.
                                    </p>
                                </div>
                                <div class="item__avatar"></div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="sect sect--padding-bottom" id="contact">
        <div class="container">
            ...
            tel. <a href="#" class="contacts__info-link">+1 234 567 890</a>
                        ...
                        <p class="contacts__info">
                            m. <a class="contacts__info-link"
                                href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;&#114;&#101;&#97;&#99;&#104;&#119;&#101;&#98;&#101;&#114;&#64;&#99;&#111;&#116;&#116;&#111;&#110;&#115;&#101;&#101;&#100;&#115;&#46;&#111;&#114;&#103;">&#82;&#101;&#97;&#99;&#104;&#87;&#101;&#98;&#101;&#114;&#64;&#99;&#111;&#116;&#116;&#111;&#110;&#115;&#101;&#101;&#100;&#115;&#46;&#111;&#114;&#103;</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="sect sect--violet ">
        <img src="https://image.ibb.co/fWyVtb/path3762.png" alt='career' class="career-img">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-xs-6">
                    <img class="footer__img" alt='weber graphics logo' src="weber-gd.svg" />
                    <h5 class="footer__title">
                        Weber<span class="footer__light"> Graphics</span>
                    </h5>
                </div>
                <div class="col-md-10 col-xs-6">
                  ...
                  />
                        ...
                        <a href="https://www.instagram.com/cottonseedsorg/"" class=" footer__social-l">
                            <img src="svg/instagram.svg" alt='instagram' class="insta" />
                        </a>
