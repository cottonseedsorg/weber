    ...
    <body>
        <header class="header">
            <div class="container header__container">
                <div class="header__logo"><img class="header__img" src="weber-gd.svg">
                ...
                <div class="header__menu">
                    <nav id="navbar" class="header__nav collapse">
                        <ul class="header__elenco">
                            ...
                            <li class="header__el header__el--blue"><a href="#contact"
                                    class="btn btn--white scroll">Contact →</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="site">
                            ...
                            <img class="site__img" src="assets/lap-gd.svg">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <a href="#" class="article-pre ">
        ...
        <div class="sect sect--padding-bottom" id="contact">
            ...
            tel. <a href="#" class="contacts__info-link">+1 234 567 890</a>
                            ...
                            <p class="contacts__info">
                                m. <a href="mailto:reachweber@cottonseeds.org"
                                    class="contacts__info-link">ReachWeber@cottonseeds.org</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-2 col-xs-6">
                        <img class="footer__img" src="weber-gd.svg" />
                  ...
                  />
                            ...
                            <a href="https://www.instagram.com/cottonseedsorg/"" class=" footer__social-l">
                                <img src="svg/instagram.svg" class="insta" />
                            </a>
